...
import ContextReviewing from './images/otter_reviewing_paper.png';
import ContextHappy from './images/otter_happy.png';
import ContextUpset from './images/otter_upset.png';
...
import ContextModIcon from './images/role_icon_mods.png';
  ...
  return (
    <div className={styles.body}>
      <div className={styles.cover}>
        {isChecking ? (
          <img src={ContextReviewing} />
        ) : whitelisted ? (
          <img src={ContextHappy} style={{ width: 240, height: 240 }} />
        ) : (
          <img src={ContextUpset} />
        )}
      </div>
      {isChecking ? (
