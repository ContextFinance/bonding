...
const lightTheme = {
  ...
  primaryButtonBG: colors.contextBlue,
  primaryButtonHoverBG: colors.contextBlueHover,
  // these need fixing
  ...
  createTheme(
    {
      ...
      overrides: {
        ...
        MuiButton: {
          ...
          outlinedPrimary: {
            color: colors.contextDark,
            borderColor: colors.contextDark,
            backgroundColor: 'fff',
            '&:hover': {
