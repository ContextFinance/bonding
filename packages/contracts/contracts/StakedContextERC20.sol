...
contract StakedContextERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20('Staked Context', 'sCTXT', 9) ERC20Permit() {
    ...
    /**
        @notice increases sCTXT supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sCTXT
