...
describe('Presale', () => {
  ...
  beforeEach(async () => {
    ...
    const PreContextERC20 = await ethers.getContractFactory('PreContextERC20')
    pClam = await PreContextERC20.deploy()
    ...
    await ContextCirculatingSupply.initialize(clam.address)
    ...
    exercisePreClam = await ExercisePreClam.deploy(
      ...
      dai.address,
      treasury.address,
      ContextCirculatingSupply.address
    )
