let addresses = {
  ...
  RESERVES: {
    ...
    FRAX_CTXT: '0x167F06eb4242fe3e5436dB7Ffa06bdE3c18Fc999',
  },
  BONDS: {
...
const reserveAddr = addresses.RESERVES.FRAX_CTXT
const isLPBond = true
...
async function main() {
  ...
  const ContextBondStakeDepository = await ethers.getContractFactory(
    'ContextBondStakeDepository'
  )
  // const bond = ContextBondStakeDepository.attach(
  //   '0xda0d7c3d751d00a1ec1c495eF7Cf3db1a202B0B9'
  // )
  const calcAddr = isLPBond ? addresses.CTXT_BONDING_CALC_ADDRESS : zeroAddress
  const bond = await ContextBondStakeDepository.deploy(
