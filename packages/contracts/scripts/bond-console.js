...
let FraxBond = await ethers.getContractFactory('ContextBondStakeDepository')
// let fraxBond = FraxBond.attach('0x5Fa0FBDb07Fe9647B43426dcc79da984f0327E4a')
let fraxBond = await FraxBond.deploy(
  addresses.CTXT_ADDRESS,
  addresses.sCTXT_ADDRESS,
  fraxAddr,
