...
async function main() {
  ...
  await verify(address.CTXT_BONDING_CALC_ADDRESS, [address.CTXT_ADDRESS])
  // await verify(newClam.address, [])
  // await verify(address.sCTXT_ADDRESS, [])
  // await verify(address.CTXT_CIRCULATING_SUPPLY, [deployer.address])
  // await verify(address.TREASURY_ADDRESS, [
  //   address.CTXT_ADDRESS,
  //   address.DAI_ADDRESS,
  //   address.RESERVES.DAI_CTXT,
  //   address.CTXT_BONDING_CALC_ADDRESS,
  //   '43200',
  // ])
  ...
  //   address.CTXT_ADDRESS,
  //   address.sCTXT_ADDRESS,
  //   epochLengthInSeconds,
  //   firstEpochNumber,
  //   firstEpochEndTime,
  // ])
  await verify(stakingWarmup, [address.STAKING_ADDRESS, address.sCTXT_ADDRESS])
  ...
  //   zeroAddress,
  // ])
  // await verify(address.BONDS.DAI_CTXT, [
  //   address.CTXT_ADDRESS,
  //   address.RESERVES.DAI_CTXT,
  //   address.TREASURY_ADDRESS,
  //   daoAddr,
